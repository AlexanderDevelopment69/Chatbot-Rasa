...
## intent:redirigir_wsp
- Quiero hablar con el recepcionista por WhatsApp
- ¿Cómo puedo contactar al recepcionista por WhatsApp?
- ¿Tienes un enlace para contactar al recepcionista por WhatsApp?
- tiene whatsApp



## intent:asistencia_pago
- Ayuda con el pago
...
## intent:consultar_registro_salida
- ¿Cuál es el horario de registro y salida?
- Quiero saber sobre el check-in y check-out.
- ¿A qué hora puedo registrarme y salir?
- Registro salida
...
## intent:consultar_cancelaciones
- ¿Cuál es la política de cancelaciones?
- ¿Cómo puedo cancelar mi reserva?
- ¿Qué sucede si necesito cancelar?

## intent:consultar_politica_edad
- ¿Cuál es la política de edad para registrarse?
- ¿A qué edad puedo registrarme en habitaciones compartidas?
- ¿Hay algún requisito de edad para alojarme en el hotel?

## intent:consultar_cargo_danios
- ¿Qué sucede si causo daños en las instalaciones?
- ¿Quién es responsable de los daños en el hotel?
- edad para reservar 
- edad para ingresar
- edad

## intent:consultar_limpieza
- ¿Cuál es la política de limpieza del hotel?
- ¿Qué se espera de los huéspedes en términos de limpieza?
- acerca de la limpieza
- limpieza

## intent:consultar_restricciones_bebidas
- ¿Puedo llevar bebidas alcohólicas al hotel?
- ¿Hay restricciones sobre las bebidas alcohólicas?
- esta prohibida las bebidas
- bebidas 
- bebidas alcoholicas
- bebidas prohibidas

## intent:consultar_horario_silencio
- ¿Cuál es el horario de silencio del hotel?
- ¿Hay restricciones de ruido durante ciertas horas?
- hay silencio
- las habitaciones son tranquilas
- silencio

## intent:consultar_mascotas
...
## intent:consultar_comportamiento_inapropiado
- ¿Qué sucede si mi comportamiento interrumpe la tranquilidad de otros huéspedes?
- ¿Cuáles son las consecuencias de comportamiento inapropiado en el hotel?
- comportamiento
- ebrios
- borrachos
- peleas
...
## intent:consultar_perdidas
- ¿Qué sucede si pierdo algo durante mi estadía en el hotel?
- ¿El hotel se hace responsable de objetos perdidos?
- si me roban
- robo
- perdidas
- es seguro
